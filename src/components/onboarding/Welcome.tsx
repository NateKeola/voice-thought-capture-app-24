    ...
    <Card className="w-full max-w-md mx-4 shadow-lg">
      <CardContent className="pt-8 px-6 pb-8">
        <div className="flex flex-col items-center mb-10">
          <div className="w-24 h-24 mb-6 rounded-full bg-gradient-to-br from-[#FF9500] to-[#F97316] flex items-center justify-center shadow-lg">
            <span className="text-3xl font-bold text-white">M</span>
          </div>
          <h1 className="text-4xl font-bold tracking-tight mb-2 font-montserrat">MEMO</h1>
        ...
        <div className="space-y-4">
          ...
          <Button 
            className="w-full justify-center h-14 rounded-2xl bg-[#FF9500] hover:bg-[#FF9500]/90 shadow-sm"
